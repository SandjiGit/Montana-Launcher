...
class Home {
    ...
    async init(config) {
        ...
        document.querySelector('.settings-start').addEventListener('click', e => changePanel('settings'))
    }
    ...
    async instancesSelect() {
        ...
        let instanceBTN = document.querySelector('.play-start')
    ...
    async startGame() {
        ...
        let playInstanceBTN = document.querySelector('.play-start')
